//
//  GoogleMapsFlutterController.swift
//  MultipleFluttersIos
//
...
class GoogleMapsFlutterController: UIViewController {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let appDelegate: AppDelegate = UIApplication.shared.delegate as! AppDelegate
        let flutterEngine = appDelegate.engines.makeEngine(withEntrypoint: "startGoogleMaps", libraryURI: nil)
